                                    ...
                                    <div class="align-items-center mt-4 pt-2 justify-content-between d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="text-muted">
                                                Mostrando <span class="fw-semibold" id="pagination-start">0</span> de
                                                <span class="fw-semibold" id="pagination-total">0</span> resultados
                                            </div>
                                        </div>
                                        <ul class="pagination pagination-separated pagination-sm mb-0 justify-content-end"
                                            id="pagination-container">
                                            <!-- Pagination auto-generated by JS -->
                                        </ul>
                                    </div>
                                </div>
                            </div>
